...
class DetailViewController: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        shadow2Button.layer.cornerRadius = 15

//        ConfigureShadowItem.button(shadowButton: shadowButton)
//        ConfigureShadowItem.button(shadowButton: shadow2Button)
        
        //CollectionViewのためのnib登録
//        let collectionNib = UINib(nibName: "HomeCollectionViewCell", bundle: Bundle.main)
//        detailCollectionView.register(collectionNib, forCellWithReuseIdentifier: "Cell")
//        detailCollectionView.delegate = self
//        detailCollectionView.dataSource = self
//        let layout = UICollectionViewFlowLayout()
//        let width = UIScreen.main.bounds.width
//        let height = detailCollectionView.frame.height
...
//        detailCollectionView.collectionViewLayout = layout
    ...
    func showCustomDialog(animated: Bool = true) {
        ...
        let buttonTwo = DefaultButton(title: "RATE", height: 60) {
            ...
            if self.cafeInfos[0].gone == false || self.cafeInfos[0].gone == nil{
                ...
                SimpleAlert.showAlert(viewController: self, title: "確認", message: "行ったに追加されました。", buttonTitle: "OK")
            }
        }
    ...
    @IBAction func wantToGo(){
        if self.cafeInfos[0].wantToGo == false || self.cafeInfos[0].wantToGo == nil{
            ...
            SimpleAlert.showAlert(viewController: self, title: "確認", message: "行ってみたいに追加されました。", buttonTitle: "OK")
        }
        ...
        query?.getObjectInBackground(withId: cafeInfos[0].objectId, block: { (post, error) in
            if error != nil {
                ...
                if post?.object(forKey: "goneUser") != nil{
                    ...
                    SimpleAlert.showAlert(viewController: self, title: "確認", message: "行ったから解除されました。", buttonTitle: "OK")
                ...
                if post?.object(forKey: "wantToGoUser") != nil{
                    ...
                    SimpleAlert.showAlert(viewController: self, title: "確認", message: "行ってみたいから解除されました。", buttonTitle: "OK")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        }else if segue.identifier == "toPlacePoint"{
            let mapViewVC = segue.destination as! MapToPlacePointViewController
            mapViewVC.selectedGeoPoint = cafeInfos[0].geoPoint
        }
    }
        ...
        query?.findObjectsInBackground({ (result, error) in
            if error != nil {
                ...
                for cafeInfoObject in result as! [NCMBObject] {
                    ...
                    //ここに代入するコードを書く
                    self.introductionLabel.text = introduciton
                    self.timeLabel.text = time
                    self.phoneNumberLabel.text = phoneNumber
                    self.moneyLabel.text = money
                    self.webLabel.text = web
                    self.navigationItem.title = text
                    //ここをimageViewからCollectionviewに変更！
...
//                self.images = []
//                for cafeInfoObject in result as! [NCMBObject]{
//                    let imageUrl = cafeInfoObject.object(forKey: "imageUrl")
//                    print("imageUrl = ",imageUrl)
//                    for element in imageUrl as! Array<Any>{
//                        print("element = ",element)
//                        self.images.append(element as! String)
//                    }
//                    print("images_afterappend = ",self.images)
//
//                }
//            }
//        })
...
//
//
//imageViewからCollectionViewに変更する用のコード
...
//        loadCafeImages()
//        print("images = ",images)
//        let cell = detailCollectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! HomeCollectionViewCell
//        print("cell_for_Item_at_images = ",self.images)
//        cell.homeImageView.kf.setImage(with: URL(string: images[indexPath.item]))
//        self.selectedImageView.kf.setImage(with:URL(string: imageUrl as! String))
//        return cell
//    }
//
